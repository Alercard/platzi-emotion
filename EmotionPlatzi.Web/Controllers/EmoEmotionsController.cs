...
namespace EmotionPlatzi.Web.Controllers
{
    public class EmoEmotionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Score,EmotionType,EmoFaceId")] EmoEmotion emoEmotion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Score,EmotionType,EmoFaceId")] EmoEmotion emoEmotion)
        {
            if (ModelState.IsValid)
            {
